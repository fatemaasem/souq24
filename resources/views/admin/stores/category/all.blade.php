...
<x-layouts :storeCategories="$storeCategories" :categoryServices="$categoryServices" :categoryPosts="$categoryPosts" title="Store Categories">
@push('action')
<x-action actionRoute="store-categories.create" deleteRoute="store-categories.deleteAll" createName="Create Store Category"/>
@endpush
											...
											<div class="col-md-6 col-xxl-4">
												...
												<div class="card">
													...
													<div class="card-body d-flex flex-center flex-column pt-12 p-9">
														...
														<!--end::Avatar-->
														<!--begin::Name-->
														<a href="{{route('store-categories.view',$category->id)}}" class="fs-4 text-gray-800 text-hover-primary fw-bolder mb-0">{{$category->name_en}}</a>
														<!--end::Name-->
														<!--begin::Position-->

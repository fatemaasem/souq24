    ...
    public function rules(): array
    {
        ...
        if ($this->isMethod('put') || $this->isMethod('patch')) {
           ...
           $rules = [
            ...
            'categoryService_id' => ['sometimes','required', 'exists:category_services,id'] // Must exist in category_posts table
             ];
        }
        else{
         ...
         $rules = [
            ...
            'categoryService_id' => ['required', 'exists:category_services,id'] // Must exist in category_posts table
        ];
    }
    return $rules;
    }
